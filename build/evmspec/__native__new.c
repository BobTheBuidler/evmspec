...
PyObject *CPyDef_HexBytes32(PyObject *cpy_r_cls, PyObject *cpy_r_v) {
    ...
    if (unlikely(cpy_r_r9 == NULL)) {
        CPy_AddTraceback("evmspec/_new.py", "HexBytes32", 39, CPyStatic_globals);
        goto CPyL36;
    } else
        goto CPyL37;
CPyL5: ;
...
CPyL6: ;
    ...
    if (unlikely(!cpy_r_r11)) {
        CPy_AddTraceback("evmspec/_new.py", "HexBytes32", 41, CPyStatic_globals);
        goto CPyL35;
    }
    CPy_Unreachable();
CPyL9: ;
    ...
    cpy_r_r15 = CPyStatic_MISSING_BYTES;
...
CPyL13: ;
    CPy_Unreachable();
CPyL14: ;
    cpy_r_r17 = CPyObject_Size(cpy_r_r14);
    if (unlikely(cpy_r_r17 == CPY_INT_TAG)) {
        CPy_AddTraceback("evmspec/_new.py", "HexBytes32", 43, CPyStatic_globals);
        goto CPyL18;
    }
    cpy_r_r18 = CPySequenceTuple_GetItem(cpy_r_r15, cpy_r_r17);
    CPyTagged_DECREF(cpy_r_r17);
    if (unlikely(cpy_r_r18 == NULL)) {
        CPy_AddTraceback("evmspec/_new.py", "HexBytes32", 43, CPyStatic_globals);
        goto CPyL18;
    }
    if (likely(PyBytes_Check(cpy_r_r18) || PyByteArray_Check(cpy_r_r18)))
        cpy_r_r19 = cpy_r_r18;
    else {
        CPy_TypeErrorTraceback("evmspec/_new.py", "HexBytes32", 43, CPyStatic_globals, "bytes", cpy_r_r18);
        goto CPyL18;
    }
    goto CPyL32;
CPyL18: ;
    ...
    cpy_r_r22 = CPyStatics[6]; /* 'KeyError' */
    ...
    cpy_r_r26 = PyObject_Repr(cpy_r_v);
    if (unlikely(cpy_r_r26 == NULL)) {
        CPy_AddTraceback("evmspec/_new.py", "HexBytes32", 45, CPyStatic_globals);
        goto CPyL39;
    }
    cpy_r_r27 = CPyStatics[7]; /* ' is too long: ' */
    cpy_r_r28 = CPyObject_Size(cpy_r_r14);
    ...
    cpy_r_r30 = CPyStr_Build(3, cpy_r_r26, cpy_r_r27, cpy_r_r29);
...
CPyL32: ;
    ...
    cpy_r_r39 = PyNumber_Add(cpy_r_r19, cpy_r_r14);
...
__LL1: ;
    ...
    return retval;
fail: ;
    CPy_AddTraceback("evmspec/_new.py", "HexBytes32", 35, CPyStatic_globals);
    return NULL;
}
...
CPyL3: ;
    ...
    cpy_r_r15 = CPyStatics[30]; /* (('cchecksum', 'cchecksum', 'cchecksum'),
                                   ('faster_eth_utils', 'faster_eth_utils',
                                    'faster_eth_utils')) */
    cpy_r_r16 = CPyStatic_globals;
    cpy_r_r17 = CPyStatics[17]; /* 'evmspec/_new.py' */
    cpy_r_r18 = CPyStatics[18]; /* '<module>' */
    cpy_r_r19 = CPyImport_ImportMany(cpy_r_r15, cpy_r_r12, cpy_r_r16, cpy_r_r17, cpy_r_r18, cpy_r_r14);
    if (!cpy_r_r19) goto CPyL28;
    cpy_r_r20 = CPyStatics[31]; /* ('AnyAddress',) */
    cpy_r_r21 = CPyStatics[20]; /* 'eth_typing' */
    ...
    CPy_DECREF(cpy_r_r23);
    cpy_r_r24 = CPyStatics[21]; /* '__T' */
    cpy_r_r25 = CPyStatic_globals;
    cpy_r_r26 = CPyStatics[12]; /* 'TypeVar' */
    cpy_r_r27 = CPyDict_GetItem(cpy_r_r25, cpy_r_r26);
    if (unlikely(cpy_r_r27 == NULL)) {
        CPy_AddTraceback("evmspec/_new.py", "<module>", 8, CPyStatic_globals);
        goto CPyL28;
    }
...
CPyL20: ;
    ...
    cpy_r_r54 = CPyStatics[23]; /* 'MISSING_BYTES' */
    ...
    CPyStatic_to_bytes = cpy_r_r61;
    CPy_INCREF(CPyStatic_to_bytes);
    cpy_r_r62 = CPyStatic_globals;
    cpy_r_r63 = CPyStatics[24]; /* 'to_bytes' */
...
const int CPyLit_Tuple[] = {
    5, 4, 10, 11, 12, 13, 3, 15, 15, 15, 3, 16, 16, 16, 2, 28, 29, 1,
    19
};
